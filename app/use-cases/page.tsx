            ...
            <div className="container mx-auto px-4 lg:px-8 py-16">
                <div className="bg-yellow-50 border-2 border-yellow-400 rounded-lg p-8">
                    ...
                    <p className="mb-4 text-yellow-700">
                        The use cases page document hasn't been created in Prismic yet. Please follow these steps:
                    </p>
...
export async function generateMetadata(): Promise<Metadata> {
    ...
    try {
        ...
        return {
            title: (page.data.meta_title as string) || "Use Cases - Positivus Digital Marketing",
            description: (page.data.meta_description as string) || "See how we've helped businesses succeed with our digital marketing services",
            openGraph: {
                title: (page.data.meta_title as string) || "Use Cases - Positivus Digital Marketing",
                description: (page.data.meta_description as string) || "See how we've helped businesses succeed",
        ...
        return {
            ...
            description: "See how we've helped businesses succeed with our digital marketing services",
        };
    }
}
