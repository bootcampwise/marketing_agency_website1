...
export default async function AboutPage() {
    ...
    try {
        ...
        const teamSlice = homepage.data.slices?.find((s: any) => s.slice_type === "team");
        const servicesSlice = homepage.data.slices?.find((s: any) => s.slice_type === "services");
            ...
            <div className="container mx-auto px-4 lg:px-8 py-16">
                <div className="bg-yellow-50 border-2 border-yellow-400 rounded-lg p-8">
                    ...
                    <p className="mb-4 text-yellow-700">
                        The about page document hasn't been created in Prismic yet. Please follow these steps:
                    </p>
                    ...
                    <p className="mt-4 text-sm text-yellow-600">
                        The Team and Services sections will automatically appear from the homepage data.
                    </p>
                </div>
            </div>
        );
...
export async function generateMetadata(): Promise<Metadata> {
    ...
    try {
        ...
        return {
            title: page.data.meta_title || "About Us - Positivus Digital Marketing Agency",
            description: page.data.meta_description || "Learn about our team and the services we offer to help businesses grow and succeed online.",
            openGraph: {
                title: page.data.meta_title || "About Us - Positivus Digital Marketing Agency",
                description: page.data.meta_description || "Learn about our team and services",
        ...
        return {
            ...
            description: "Learn about our team and the services we offer to help businesses grow and succeed online.",
        };
    }
}
