            ...
            <div className="container mx-auto px-4 lg:px-8 py-16">
                <div className="bg-yellow-50 border-2 border-yellow-400 rounded-lg p-8">
                    ...
                    <p className="mb-4 text-yellow-700">
                        The homepage document hasn't been created in Prismic yet. Please follow these steps:
                    </p>
                    ...
                    <p className="mt-4 text-sm text-yellow-600">
                        Check the <code className="bg-yellow-100 px-2 py-1 rounded">HOMEPAGE_PRISMIC_GUIDE.md</code> file for detailed instructions.
                    </p>
                </div>
            </div>
        );
...
export async function generateMetadata(): Promise<Metadata> {
    ...
    try {
        ...
        return {
            ...
            description: page.data.meta_description || "Our digital marketing agency helps businesses grow and succeed online through a range of services including SEO, PPC, social media marketing, and content creation.",
            openGraph: {
                title: page.data.meta_title || "Positivus - Digital Marketing Agency",
                description: page.data.meta_description || "Our digital marketing agency helps businesses grow and succeed online",
