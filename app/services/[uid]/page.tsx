...
export default async function ServiceDetailPage({
  ...
  try {
    ...
    console.error(
      `Error fetching service detail page for UID "${params.uid}":`,
      error,
    );
      ...
      <div className="container mx-auto px-4 lg:px-8 py-16">
        <div className="bg-yellow-50 border-2 border-yellow-400 rounded-lg p-8">
          ...
          <p className="mb-4 text-yellow-700">
            The service page with UID "
            <code className="bg-yellow-100 px-2 py-1 rounded">
              {params.uid}
            </code>
            " hasn't been created in Prismic yet.
          </p>
          <p className="mb-4 text-yellow-700">Please follow these steps:</p>
          <ol className="list-decimal list-inside space-y-2 text-yellow-700">
            <li>
              Open Slice Machine (run:{" "}
              <code className="bg-yellow-100 px-2 py-1 rounded">
            ...
            <li>
              Create a new "Service Detail Page" document with UID:{" "}
              <code className="bg-yellow-100 px-2 py-1 rounded">
                {params.uid}
              </code>
            </li>
