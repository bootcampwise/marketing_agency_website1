  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row lg:items-center gap-4 lg:gap-8 mb-12">
        ...
        <p className="text-base lg:text-lg max-w-full lg:max-w-[292px]">
      ...
      <div className="space-y-6">
        {slice.items.map((item, index) => (
          <div
            key={index}
            className={`border-2 border-b-8 border-dark rounded-3xl overflow-hidden transition-all ${
            ...
            >
              <div className="flex items-center gap-3 lg:gap-6">
                <span className="text-3xl lg:text-5xl font-bold">
                  {getText(item.step_number)}
                </span>
                <h3 className="text-lg lg:text-2xl font-semibold">
                  {getText(item.step_title)}
                </h3>
              </div>
              <div
                className={`w-10 h-10 lg:w-12 lg:h-12 rounded-full border-2 border-dark flex items-center justify-center text-xl lg:text-2xl flex-shrink-0 ${
