 ...
 */
export type ServiceCardProps = SliceComponentProps<any>;
...
const ServiceCard = ({ slice }: ServiceCardProps): JSX.Element => {
    ...
    const content = (
        <>
            {/* Large Service Card */}
            <div className={`${bgColorMap[bgColor]} border-2 border-b-8 border-dark rounded-[45px] p-8 md:p-12 lg:p-16 relative mb-12 transition-all duration-300 hover:shadow-xl`}>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    ...
                    <div className="flex flex-col justify-between h-full min-h-[200px] space-y-6">
                        ...
                        <div className="flex flex-col items-start">
                            <span className={`font-medium text-3xl text-dark leading-tight ${badgeBgMap[bgColor]} px-2 py-1 rounded-lg`}>
                        ...
                        <div className="mt-auto">
                            ...
                            >
                                ...
                                {/* Text */}
                                <span className={`font-medium text-base ${textColor} group-hover:underline transition-all duration-300`}>
                                    Service info
                                </span>
                            </Link>
                        </div>
